          ...
          <div className="lg:col-span-7 space-y-6 text-white text-left animate-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-4 max-w-xl">
              ...
              <div className="bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded text-left">
                ...
                <span className="font-serif text-xl sm:text-2xl font-bold text-accent">Mulai 950Jt*</span>
              </div>
            </div>
              ...
              <div className="overflow-y-auto p-6 md:p-8 flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="relative aspect-[3/4] md:aspect-auto md:h-[450px] bg-slate-50 border border-gray-150 rounded-xl overflow-hidden flex items-center justify-center p-4">
                    ...
                    />
                    <div className="absolute bottom-3 left-3 bg-slate-900/80 text-white text-[9px] px-2 py-1 rounded">
                      Ilustrasi Detail Tipe Unit {selectedUnit.number}
                    </div>
                  </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            {["all", "exterior", "living-room", "bedroom", "kitchen", "bathroom"].map((tab) => (
              <button
                key={tab}
